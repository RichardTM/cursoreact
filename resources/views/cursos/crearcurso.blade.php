                                ...
                                <div class="col-md-5 mx-auto borde1 pl-5 pr-5 pb-3 shadow p-3 mb-5 bg-white rounded">
                                    ...
                                    <form action="{{url('/cursos')}}" method="POST" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Escriba el nombre del curso" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="">imagen</label>
                                            <input type="text" class="form-control" id="imagen" name="imagen" placeholder="Escriba el nombre del curso" required>
                                        </div>
